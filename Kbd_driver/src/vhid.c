/*
Обмен данными с Custom-HID устройствами. Вот эту штуку я более-менее постарался сделать
по-человечески, но сам способ обмена по USB довольно сложный, так что пока работает,
лучше сюда не лезть
*/
...
//ВАЖНО! wIndex должен совпадать с номером интерфейса HID
