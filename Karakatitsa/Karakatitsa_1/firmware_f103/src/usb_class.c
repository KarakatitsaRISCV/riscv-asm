...
// /dev/ttyACM2 (interfaces 4, 5) - LOG
  ARRLEN1( //IAD
    bLENGTH,
    0x0B, //IAD descriptor
    ifnum( interface_log ), //2, //bFirstInterface
    ifcnt( interface_log ), //2, //bInterfaceCount
    DEVCLASS_CDC, // bInterfaceClass: 
    CDCSUBCLASS_ACM, // bInterfaceSubClass: 
    CDCPROTOCOL_UNDEF, // bInterfaceProtocol: 
    STR_LOG, //0x00, // iFuncion
  )
  ARRLEN1(//CDC control Interface
    bLENGTH, // bLength
    USB_DESCR_INTERFACE, // bDescriptorType
    ifnum( interface_log ), //2, // bInterfaceNumber
    0, // bAlternateSetting
    1, // bNumEndpoints
    DEVCLASS_CDC, // bInterfaceClass: 
    CDCSUBCLASS_ACM, // bInterfaceSubClass: 
    CDCPROTOCOL_UNDEF, // bInterfaceProtocol: 
    STR_LOG, //0x00, // iInterface
  )
    ARRLEN1(//Header
      bLENGTH, //bLength
      USB_DESCR_CS_INTERFACE, //bDescriptorType
    ...
    ARRLEN1( //Call mamagement
      ...
      0x01, //Call mamagement
      0x00, //TODO: bmCapabilities D0+D1
      ifnum( interface_log )+1, //3, //bDataInterface
    )
    ARRLEN1( //ACM
      bLENGTH,
      USB_DESCR_CS_INTERFACE,
    ...
    ARRLEN1( //Union
      ...
      USB_DESCR_CS_INTERFACE,
      6, //bDescriptorSubType = Union
      ifnum( interface_log ), //2, //bMasterInterface = Communication class interface
      ifnum( interface_log )+1, //3, //bSlaveInterface0 = Data Class Interface
    )
    ARRLEN1(//Endpoint descriptor
      bLENGTH, //bLength
      USB_DESCR_ENDPOINT, //bDescriptorType
  ...
  ARRLEN1( //CDC data interface
    bLENGTH,
    USB_DESCR_INTERFACE,
    ifnum( interface_log )+1, //3, //bInterfaceNumber
    0, //bAlternateSetting
    2, //bNumEndpoints
    CDCCLASS_DATA, //bInterfaceClass
    0, //bInterfaceSubClass
